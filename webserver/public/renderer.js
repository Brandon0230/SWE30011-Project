...
function updateDoorStatus(status) {
    var doorStatusElement = document.getElementById("doorStatus");
    var doorIcon = document.getElementById("doorIcon");
    var doorText = document.getElementById("doorText");

    if (status === "1") { // example 1 is open 0 is locked
        doorStatusElement.className = 'door-status unlocked';
        doorIcon.src = "SWE30011-Project-latest-backend/build/webserver/public/img/locked-icon.png"; //
